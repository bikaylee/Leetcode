...
| 56. Merge Intervals                               | 🟠   | `Array` `Sort`                                             | 253     | &#10004; |     |     |
...
| 253. Meeting Rooms II                             | 🟠   | `Array` `Two Pointers` `Greedy` `Sort` `Heap`              | 56      | &#10004; |     |     |
...
| 350. Intersection of Two Arrays II                | 🟢   | `Array` `Hash Table` `Two Pointers` `Binary Search` `Sort` |         | &#10004; |     |     |
...
| 463. Island Perimeter                             | 🟢   | `Array` `DFS` `BFS` `Matrix`                               |         | &#10004; |     |     |
...
| 567. Permutation in String                        | 🟠   | `String` `Hash Table` `Two Pointers` `Sliding Window`      |         | &#10004; |     |     |
...
| 1509. Min Diff Between Max and Min Val in 3 Moves | 🟠   | `Array` `Sort` `Greedy`                                    |         | &#10004; |     |     |
| 1525. Number of Good Ways to Split a String       | 🟠   | `String` `DP` `Bit Manipulation`                           |         | &#10004; |     |     |
